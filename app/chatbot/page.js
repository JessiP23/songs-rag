...
// Chatbot feature where users can enter a request (asking for songs) the chatbot then return an answer
export default function Chatbot() {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      // empty result initiated. 
      let result = '';

      // process answer to be added to result
    ...
    if (user) {
      ...
      try {
        // Correct reference to add info to firebase
        const userSongsRef = collection(doc(db, 'users', user.id), 'songs'); 
